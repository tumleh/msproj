...
The performance for the different schedulers is with equal length packets and variable length packets is comparable as seen in figures \ref{vs_spreadagg} and \ref{us_spreadagg}.
...
\begin{figure}%[h]
	...
	\caption{This graph shows the delays experienced by a typical set of datacenter flows with variable packet sizes.}
	\label{typ_vs}
\end{figure}
...
\begin{figure}%[h]
	...
	\caption{This graph shows the delay spread of the flows under a simulated spread and aggregate pattern the packet lengths in this simulation are presumed to be variable.}
	\label{vs_spreadagg}
\end{figure}
